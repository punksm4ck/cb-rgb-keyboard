...
if "self.log_tab" not in content:
    ...
    '''
    content = content.replace("self.notebook.add(self.api_tab, text=\"API Control\")", "self.notebook.add(self.api_tab, text=\"API Control\")\n        " + tab_patch)
...
if "self.api_test_tab" not in content:
    ...
    '''
    content = content.replace("self.notebook.add(self.log_tab, text=\"Logs\")", "self.notebook.add(self.log_tab, text=\"Logs\")\n        " + api_test_patch)
